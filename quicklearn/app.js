        ...
        content += `
            <div class="navbar">
                ...
                <div class="nav-links">
                    ...
                    <span style="border-left: 1px solid #ccc; padding-left: 15px; color: #6c757d; cursor: pointer; transition: color 0.2s;" onclick="navigate('/profile')" onmouseover="this.style.color='#FF9800'" onmouseout="this.style.color='#6c757d'">Halo, <strong id="navUsername">${state.currentUser.name}</strong></span>
...
function renderLogin() {
    return `
        <div class="card" style="max-width: 450px; margin: 4rem auto;">
            <h2 style="text-align: center; color: #FF9800; margin-bottom: 2rem;">QuickLearn Pro</h2>
            ...
            <div style="text-align: center; margin-top: 1.5rem; font-size: 0.95rem;">
                Belum memiliki akun? <a style="cursor:pointer; color:#FF9800; font-weight: 500;" onclick="navigate('/register')">Daftar sekarang</a>
            </div>
...
function renderRegister() {
    return `
        <div class="card" style="max-width: 450px; margin: 4rem auto;">
            ...
            <div style="text-align: center; margin-top: 1.5rem; font-size: 0.95rem;">
                Sudah memiliki akun? <a style="cursor:pointer; color:#FF9800; font-weight: 500;" onclick="navigate('/login')">Login di sini</a>
            </div>
        </div>
    `;
}
...
function renderDashboard() {
    let html = `
        <div style="margin-bottom: 2rem;">
            <h1 style="color: #FF9800;">Mari Uji Kemampuanmu Lewat Quiz</h1>
    ...
    subjects.forEach(subject => {
        html += `
            <div class="card" style="text-align: center; cursor: pointer; border-bottom: 4px solid #FF9800; transition: transform 0.2s;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'" onclick="navigate('/quiz-topics', { subject: '${subject}' })">
                <div style="width: 80px; height: 80px; background: #FFF3E0; color: #FF9800; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem; font-size: 2rem; font-weight: bold;">
                    ${subject.charAt(0)}
                </div>
                <h3>${subject}</h3>
            </div>
...
function renderQuizTopics(params) {
    ...
    let html = `
        <div style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1 style="color: #FF9800; text-transform: uppercase;">${subject}</h1>
        ...
        html += `
            <div class="card" style="display: flex; align-items: center; justify-content: space-between; padding: 1.5rem; cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='translateX(5px)'" onmouseout="this.style.transform='translateX(0)'" onclick="startQuiz('${topic.id}')">
                <div style="display: flex; align-items: center; gap: 1.5rem;">
                    <div style="width: 50px; height: 50px; border-radius: 50%; background: #FFC107; color: white; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 1.5rem;">
                        ${index + 1}
                    </div>
                    <div>
        ...
        <div class="card">
            <div style="margin-bottom: 1rem; color: #6c757d; font-weight: 500;">
                ...
                <div style="width: 100%; height: 8px; background: #e9ecef; border-radius: 4px; margin-top: 8px;">
                    <div style="height: 100%; width: ${progressPct}%; background: #FF9800; border-radius: 4px; transition: width 0.3s;"></div>
                </div>
            </div>
    ...
    return `
        <div style="max-width: 800px; margin: 0 auto; padding: 2rem 0;">
            <div style="text-align: center; margin-bottom: 3rem;">
                <h1 style="color: #FF9800; font-size: 2.5rem; margin-bottom: 0.5rem;">Kuis Selesai!</h1>
                <p style="color: #6c757d; font-size: 1.2rem;">Berikut adalah hasil kinerja Anda untuk <b>${result.title}</b></p>
            </div>

            <div class="card" style="display: flex; flex-direction: column; align-items: center; padding: 3rem; background: linear-gradient(135deg, #FF9800, #FFC107); color: white; margin-bottom: 2rem; border: none;">
            ...
            <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); margin-bottom: 3rem;">
                <div class="card" style="text-align: center;">
                    <div style="font-size: 2rem; color: #FF9800; font-weight: bold;">${Math.round((result.correct / result.total) * 100)}%</div>
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <button onclick="startQuiz('${result.quizId}')" style="display: flex; align-items: center; gap: 8px; background: #fff; color: #FF9800; border: 2px solid #FF9800;">
                    <span style="font-size: 1.2rem;">↻</span> Ulangi Kuis
                </button>
                <button onclick="navigate('/review-answers')" style="display: flex; align-items: center; gap: 8px; background: #fff; color: #FF9800; border: 2px solid #FF9800;">
    ...
    let html = `
        <div style="max-width: 800px; margin: 0 auto; padding: 2rem 0;">
            <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem; border-bottom: 2px solid #eee; padding-bottom: 1rem;">
                ...
                <h2 style="margin: 0; color: #FF9800;">Review Jawaban</h2>
            </div>
    `;
...
function renderHistory() {
    let html = `
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            <h1 style="color: #FF9800;">Hasil Terbaru</h1>
            <button onclick="navigate('/dashboard')" style="background: #fff; color: #333; border: 1px solid #ccc;">Kembali</button>
        </div>
    `;
                ...
                <div class="card" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; padding: 1.5rem; gap: 1rem;">
                    <div style="flex: 1; min-width: 250px;">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                            <div style="width: 40px; height: 40px; border-radius: 50%; background: #FF9800; color: white; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 1.2rem;">
                                ${index + 1}
                            </div>
                            <div>
                    ...
                    <div style="text-align: right; border-left: 1px solid #eee; padding-left: 1.5rem;">
                        <div style="font-size: 1.8rem; font-weight: 800; color: #FF9800;">${h.scorePoints}<span style="font-size: 1rem;">Pt</span></div>
...
function renderMateriSubjects() {
    let html = `
        <div style="margin-bottom: 2rem;">
            <h1 style="color: #FF9800;">Materi Belajar</h1>
    ...
    Object.keys(materiDatabase).forEach(key => {
        ...
        html += `
            <div class="card" style="text-align: center; cursor: pointer; border-bottom: 4px solid #FF9800; transition: transform 0.2s;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'" onclick="navigate('/materi/class', { subjectKey: '${key}' })">
                <div style="width: 80px; height: 80px; background: #FFF3E0; color: #FF9800; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem; font-size: 2rem; font-weight: bold;">
...
function renderMateriClasses(params) {
    ...
    let html = `
        <div style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1 style="color: #FF9800;">Yuk pilih Kelasmu!</h1>
    ...
    subject.classes.forEach(cls => {
        html += `
            <div class="card" style="text-align: center; cursor: pointer; border: 2px solid #e9ecef; transition: border-color 0.2s;" onmouseover="this.style.borderColor='#FF9800'" onmouseout="this.style.borderColor='#e9ecef'" onclick="navigate('/materi/timeline', { subjectKey: '${params.subjectKey}', classLevel: '${cls.level}' })">
                <h2 style="color: #FF9800; margin-bottom: 0;">Kelas</h2>
...
function renderMateriTimeline(params) {
    ...
    let html = `
        <div style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1 style="color: #FF9800; text-transform: uppercase;">${subject.name}</h1>
    ...
    html += `<div style="position: relative; margin-left: 20px; padding-left: 30px; border-left: 4px solid #FF9800;">`;
    
    cls.videos.forEach(v => {
        html += `
            <div style="position: relative; margin-bottom: 2rem;">
                <div style="position: absolute; left: -44px; top: 20px; width: 24px; height: 24px; background: white; border: 4px solid #FF9800; border-radius: 50%;"></div>
...
function renderMateriWatch(params) {
    ...
    let html = `
        <div style="margin-bottom: 1rem;">
            ...
            <h1 style="color: #FF9800; margin-bottom: 0;">${video.title}</h1>
        ...
        <div class="card" style="padding: 0; overflow: hidden; margin-bottom: 2rem;">
                ...
                ${video.ytId ? 
                    ...
                    `<div style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center;">
                        <div style="width: 80px; height: 80px; background: rgba(255,255,255,0.9); border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
                            <span style="font-size: 3rem; color: #FF9800; margin-left: 10px;">▶</span>
                        </div>
                    </div>`
                }
            </div>
            <div style="padding: 1rem 2rem; display: flex; justify-content: space-between; align-items: center; background: #fff; border-top: 1px solid #eee;">
                ...
                <div style="display: flex; gap: 1.5rem;">
                    <span style="cursor: pointer; font-size: 1.2rem; color: #FF9800; font-weight: 500;" onclick="shareVideo('${video.ytId}', '${video.title}')">🔗 Bagikan</span>
                </div>
            </div>
        </div>
        ...
        video.chapters.forEach((chap, idx) => {
            ...
            html += `
                <div style="position: relative; margin-bottom: 1.5rem;">
                    <div style="position: absolute; left: -36px; top: 15px; width: 12px; height: 12px; background: ${isFirst ? 'white' : '#FFC107'}; border: 3px solid #FFC107; border-radius: 50%;"></div>
                    <div class="card" style="padding: 1.5rem;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 1.5rem;">
                            <p style="margin: 0; color: #555; font-size: 1rem; line-height: 1.6;">${chap.desc}</p>
                            <span style="color: #FF9800; font-size: 0.9rem; font-weight: bold; background: #FFF3E0; padding: 6px 12px; border-radius: 6px;">${chap.time}</span>
                        </div>
                    </div>
                </div>
            `;
    ...
    if (state.currentPath === '/take-quiz' && activeQuizState) {
        if (activeQuizState.questionTimer > 0) {
            ...
            if (elapsed > 10) {
                ...
                bonusColor = bonusPct > 50 ? '#ffc107' : '#dc3545';
...
function renderProfile() {
    ...
    return `
        <div style="max-width: 900px; margin: 0 auto; position: relative;">
            <button style="position: absolute; right: 0; top: 0; background: #FF9800; color: white; border: none; width: 45px; height: 45px; border-radius: 8px; font-size: 1.5rem; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.1);" title="Settings">
                ⚙️
            </button>
            
            <div style="text-align: center; margin-bottom: 3rem; padding-top: 2rem;">
                <div style="width: 100px; height: 100px; background: #FFF3E0; border-radius: 50%; margin: 0 auto 1.5rem; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 20px rgba(255,152,0,0.15);">
            ...
            <div class="grid" style="grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 3rem;">
                <div class="card" style="background: linear-gradient(135deg, #FFC107, #FFCA28); color: white; text-align: center; padding: 2.5rem; border: none; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
                ...
                <div class="card" style="background: linear-gradient(135deg, #FFCA28, #FFC107); color: white; text-align: center; padding: 2.5rem; border: none; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
                ...
                <div class="card" style="background: linear-gradient(135deg, #FFB300, #FFC107); color: white; text-align: center; padding: 2.5rem; border: none; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
                ...
                <div class="card" style="background: linear-gradient(135deg, #FFC107, #FFB300); color: white; text-align: center; padding: 2.5rem; border: none; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
